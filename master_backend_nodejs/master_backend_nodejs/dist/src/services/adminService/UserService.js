...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.createUser = function (userData) {
        return __awaiter(this, void 0, void 0, function () {
            var newUser;
            return __generator(this, function (_a) {
                newUser = __assign(__assign({}, userData), { id: Date.now() });
    ...
    UserService.prototype.updateUser = function (id, userData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.users[userIndex] = __assign(__assign({}, this.users[userIndex]), userData);
                return [2 /*return*/, this.users[userIndex]];
            });
        });
    };
    ...
    UserService.prototype.changeUserStatus = function (id, status) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.updateUser(id, { status: status })];
            });
        });
    };
    return UserService;
