            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, insertedRequest];
                }
            });
        });
    },
    getRequestsByStudent: function (studentId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, databaseService_1.DatabaseService.query("SELECT * FROM academic_requests WHERE student_id = $1 ORDER BY created_at DESC", [studentId])];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    },
    updateRequestStatus: function (requestId, status, response, actionBy) {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, databaseService_1.DatabaseService.query("UPDATE academic_requests SET status = $1, response = $2, action_by = $3, updated_at = NOW() WHERE id = $4", [status, response, actionBy, requestId])];
                    case 1:
                        _b.sent();
