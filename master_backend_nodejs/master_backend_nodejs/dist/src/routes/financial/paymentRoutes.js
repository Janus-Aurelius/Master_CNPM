...
router.get('/status', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, paymentController_1.financialPaymentController.getPaymentStatusList(req, res)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
router.get('/history/:studentId', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, paymentController_1.financialPaymentController.getStudentPaymentHistory(req, res)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
// Get payment receipt
router.get('/receipt/:paymentId', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, paymentController_1.financialPaymentController.getPaymentReceipt(req, res)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
router.get('/audit', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, paymentController_1.financialPaymentController.getPaymentAudit(req, res)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
router.get('/statistics', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
