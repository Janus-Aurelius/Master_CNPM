...
var financialController = __importStar(require("../../controllers/financialController/financialController"));
...
// Unpaid Report
router.get('/unpaid-report', financialController_1.default.getUnpaidTuitionReport);
