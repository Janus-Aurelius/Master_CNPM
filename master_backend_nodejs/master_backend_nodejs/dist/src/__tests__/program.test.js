            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, program_business_1.ProgramBusiness.updateProgram(updateData.maNganh, updateData.maMonHoc, updateData.maHocKy, updateData)];
                    case 1:
                        result = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(program_business_1.ProgramBusiness.updateProgram(updateData.maNganh, updateData.maMonHoc, updateData.maHocKy, updateData))
