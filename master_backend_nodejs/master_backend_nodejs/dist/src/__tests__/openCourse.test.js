    ...
    describe('createCourse', function () {
        ...
        it('should validate required fields', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        invalidCourse = __assign(__assign({}, newCourse), { subjectCode: '' });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, openCourse_business_1.OpenCourseBusiness.getCoursesBySemester('Fall', '2024')];
                    case 1:
                        result = _a.sent();
                        expect(result).toEqual(mockCourses);
                        expect(openCourse_service_1.OpenCourseService.getCoursesBySemester).toHaveBeenCalledWith('Fall', '2024');
                        return [2 /*return*/];
                }
            });
        }); });
        it('should validate required parameters', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, expect(openCourse_business_1.OpenCourseBusiness.getCoursesBySemester('Fall', '')).rejects.toThrow(validation_error_1.ValidationError)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
