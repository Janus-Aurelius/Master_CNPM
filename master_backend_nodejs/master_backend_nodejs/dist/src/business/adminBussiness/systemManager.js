...
var SystemManager = /** @class */ (function () {
    ...
    SystemManager.prototype.getSecuritySettings = function () {
    ...
    SystemManager.prototype.updateSecuritySettings = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, systemService_1.securityService.updateSecuritySettings(data)];
                    case 1: 
                    // Validate nếu muốn
...
exports.systemManager = new SystemManager();
