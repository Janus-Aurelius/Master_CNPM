...
var ProgramBusiness = /** @class */ (function () {
    ...
    ProgramBusiness.createProgram = function (programData) {
        return __awaiter(this, void 0, void 0, function () {
            var errors, _a, monHocExists, hocKyExists, error_3;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                program_service_1.ProgramService.checkMonHocExists(programData.maMonHoc),
                                program_service_1.ProgramService.checkHocKyExists(programData.maHocKy)
                            ])];
                    case 1:
                        _a = _b.sent(), monHocExists = _a[0], hocKyExists = _a[1];
                        if (!monHocExists) {
                            throw new validation_error_1.ValidationError('Mã môn học không tồn tại trong hệ thống');
                        }
                        if (!hocKyExists) {
                            throw new validation_error_1.ValidationError('Mã học kỳ không tồn tại trong hệ thống');
                        }
    ...
    ProgramBusiness.updateProgram = function (maNganh, maMonHoc, maHocKy, programData) {
        return __awaiter(this, void 0, void 0, function () {
            var errors, monHocExists, hocKyExists, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
                        ...
                        if (!programData.maMonHoc) return [3 /*break*/, 2];
                        return [4 /*yield*/, program_service_1.ProgramService.checkMonHocExists(programData.maMonHoc)];
                    case 1:
                        monHocExists = _a.sent();
                        if (!monHocExists) {
                            throw new validation_error_1.ValidationError('Mã môn học mới không tồn tại trong hệ thống');
                        }
                        _a.label = 2;
                    case 2:
                        if (!programData.maHocKy) return [3 /*break*/, 4];
                        return [4 /*yield*/, program_service_1.ProgramService.checkHocKyExists(programData.maHocKy)];
                    case 3:
                        hocKyExists = _a.sent();
                        if (!hocKyExists) {
                            throw new validation_error_1.ValidationError('Mã học kỳ mới không tồn tại trong hệ thống');
                        }
                        _a.label = 4;
                    case 4: return [4 /*yield*/, program_service_1.ProgramService.updateProgram(maNganh, maMonHoc, maHocKy, programData)];
    ...
    ProgramBusiness.validateSemester = function (maHocKy) {
        return __awaiter(this, void 0, void 0, function () {
            var error_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, program_service_1.ProgramService.checkHocKyExists(maHocKy)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        error_8 = _a.sent();
                        console.error('Error in ProgramBusiness.validateSemester:', error_8);
                        throw error_8;
                    case 3: return [2 /*return*/];
                }
            });
    ...
    ProgramBusiness.processExcelData = function (file) {
        return __awaiter(this, void 0, void 0, function () {
            var workbook, sheetName, sheet, data, programs, _i, data_1, row, program, errors, _a, _b, error_9;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 5:
                        error_9 = _c.sent();
                        if (error_9 instanceof validation_error_1.ValidationError) {
                            throw error_9;
                        }
