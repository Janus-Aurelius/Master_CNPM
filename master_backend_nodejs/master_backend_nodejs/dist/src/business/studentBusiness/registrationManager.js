...
var RegistrationManager = /** @class */ (function () {
    function RegistrationManager() {
        this.registrationService = subjectRegistrationService_1.subjectRegistrationService;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.registrationService.getAvailableSubjects(semester)];
                    case 1:
                        subjects = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.registrationService.searchSubjects(cleanQuery, semester)];
                    case 1:
                        subjects = _a.sent();
                        return [2 /*return*/, subjects];
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.registrationService.registerSubject(studentId, courseId, semester)];
                    case 1:
                        // Additional business validations can be added here:
                        // 1. Check if student has met prerequisites
                        // 2. Check for schedule conflicts
