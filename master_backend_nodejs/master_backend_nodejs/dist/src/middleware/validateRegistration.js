...
var registrationValidationRules = function () {
    return [
...
var validateRegistration = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Promise.all(registrationValidationRules().map(function (validation) { return validation.run(req); }))];
            case 1:
                _a.sent();
