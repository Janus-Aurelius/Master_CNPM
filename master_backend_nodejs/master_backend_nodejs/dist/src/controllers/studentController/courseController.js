...
var courseManager = __importStar(require("../business/courseManager"));
...
var getCoursesHandler = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, courseManager.listCourses()];
            case 1:
                courses = _a.sent();
                res.json(courses);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, courseManager.getCourseById(parseInt(id))];
            case 1:
                course = _a.sent();
                if (!course) {
                    throw new errorHandler_1.AppError(404, 'Course not found');
                }
                res.json(course);
                return [3 /*break*/, 3];
            case 2:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                courseData = req.body;
                return [4 /*yield*/, courseManager.createCourse(courseData)];
            case 1:
                newCourse = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                id = req.params.id;
                courseData = req.body;
                return [4 /*yield*/, courseManager.updateCourse(parseInt(id), courseData)];
            case 1:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, courseManager.deleteCourse(parseInt(id))];
            case 1:
                success = _a.sent();
                if (!success) {
                    throw new errorHandler_1.AppError(404, 'Course not found');
