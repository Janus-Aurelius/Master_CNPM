    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, courseBusiness.getCourseById(parseInt(id))];
            case 1:
                course = _a.sent();
                if (!course) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                id = req.params.id;
                courseData = req.body;
                return [4 /*yield*/, courseBusiness.updateCourse(parseInt(id), courseData)];
            case 1:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, courseBusiness.deleteCourse(parseInt(id))];
            case 1:
                success = _a.sent();
                if (!success) {
                    throw new errorHandler_1.AppError(404, 'Course not found');
