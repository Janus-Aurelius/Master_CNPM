...
var SubjectController = /** @class */ (function () {
    ...
    SubjectController.getSubjectById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, subject, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        return [4 /*yield*/, subject_business_1.SubjectBusiness.getSubjectById(Number(id))];
                    case 1:
                        subject = _a.sent();
                        if (!subject) {
    ...
    SubjectController.updateSubject = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, subjectData, updatedSubject, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        subjectData = req.body;
                        return [4 /*yield*/, subject_business_1.SubjectBusiness.updateSubject(Number(id), subjectData)];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        return [4 /*yield*/, subject_business_1.SubjectBusiness.deleteSubject(Number(id))];
                    case 1:
                        _a.sent();
