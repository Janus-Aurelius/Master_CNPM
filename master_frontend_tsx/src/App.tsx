...
import StudentSubjectReqMgmAcademic from "./academic_affair_pages/studentSubjectReqMgm_academic";
                ...
                <Route path="/student/*" element={
                    ...
                    <ProtectedRoute allowedRoles={['academic']}>
                        <Routes>
                            ...
                            <Route path="studentSubjectReq" element={<StudentSubjectReqMgmAcademic user={user} onLogout={handleLogout} />} />                            <Route path="openCourseMgm" element={<OpenCourseMgmAcademic user={user} onLogout={handleLogout} />} />
