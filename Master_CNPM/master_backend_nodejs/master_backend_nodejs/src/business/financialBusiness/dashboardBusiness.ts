...
export class FinancialDashboardBusiness {
    ...
    async getDashboardOverview(semesterId?: string) {
        try {
            ...
            const partialStudents = stats.partialStudents || 0;
            ...
            return {
                ...
                financial: {
                    totalTuition: stats.totalTuition || 0,
                    totalCollected: stats.totalCollected || 0,
                    totalOutstanding: (stats.totalTuition || 0) - (stats.totalCollected || 0)
                }
            };
        } catch (error) {
            throw new Error('Error processing dashboard overview data');
        }
    }    /**
